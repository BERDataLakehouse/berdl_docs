...
| | |
|---|---|
| **Docker Image** | `ghcr.io/kbasedatalakehouse/tenant_access_request_service:main` |
| **GitHub Repo** | [tenant_access_request_service](https://github.com/KBaseDataLakehouse/tenant_access_request_service) |
| **Python** | 3.13 |
